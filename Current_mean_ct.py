...
class Current_Mean_CT():
    ...
    def output(self):
        ...
        print(self.DFDBClient.write_points(x, cg.Current_mean_ct))
        return x


a = {'CT11': 29, 'CT12': 16, 'CT13': 16, 'CT14': 16, 'CT15': 16, 'CT16': 16, 'CT17': 16, 'CT18': 16, 'CT19': 16, 'CT120': 31}
cat = Current_Mean_CT(a)
t = cat.output()
print(t.dtypes)
print(t.columns)